require(["./main"], function (main) {
  require([
    ...
    "waypoints",
    "global",
  ], function ($, domReady, tweenmax, $bxslider, waypoints, global) {
    var h = {
      banner_anim: function () {
        function start_anim() {
          TweenLite.to(".home-banner__anim", 1, { opacity: 1, delay: 0.5 });
          TweenLite.to("#platform, #pc", 1, {
            top: "0",
            ease: Back.easeOut,
            delay: 0.5,
          });

          TweenLite.to("#card-base", 1.1, {
            top: "-2%",
            ease: Back.easeOut,
            delay: 0.5,
          });
          ...
          TweenLite.to("#chart-base", 1, {
            top: "0",
            ease: Back.easeOut,
            delay: 0.5,
          });
          TweenLite.to("#chart-1", 1, {
            scaleY: 1,
            top: "34.2%",
            ease: Expo.easeOut,
            delay: 0.5,
          });
          TweenLite.to("#chart-2", 1, {
            scaleY: 1,
            top: "41.7%",
            ease: Expo.easeOut,
            delay: 0.5,
          });
          TweenLite.to("#chart-3", 1, {
            scaleY: 1,
            top: "55.7%",
            ease: Expo.easeOut,
            delay: 0.5,
        ...
        TweenMax.set("#platform, #card-base, #card-chip, #email", {
          top: "-10%",
        });
        ...
        TweenLite.to(".home-banner__content .headline-1", 2, {
          opacity: 1,
          delay: 1.1,
        });
        TweenLite.to(".home-banner__anim img", 1, { opacity: 1 });
        TweenLite.to(".home-banner__content p .btn", 2, {
          opacity: 1,
          delay: 0,
        });
        TweenLite.to(".l-home-banner .btn--arrow-down", 2, {
          opacity: 1,
          delay: 2,
        });
      ...
      info_box_anim: function () {
        $(".info-box").waypoint(
          function (direction) {
            TweenMax.to(".info-box__product-tour img", 1.5, {
              right: "-85%",
              ease: Expo.easeOut,
            });
            TweenMax.to(".info-box__product-tour .btn", 2, {
              opacity: 1,
              delay: 0.5,
              ease: Expo.easeOut,
            });
