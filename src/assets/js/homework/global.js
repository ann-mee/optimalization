define([
  "components/domReady",
  "components/flexbox_fallback",
  "components/placeholders.min",
  "components/magnific",
], function (domReady, fallback, $twitter, $placeholders, $magnificPopup) {
  var global = {
    megamenu: function () {
      $(".navbar-menu .navbar-menu__dropdown a").on("click", function () {
        ...
        if (!$(this).hasClass("active")) {
          $(".navbar-menu .navbar-menu__dropdown a.active").removeClass(
            "active"
          );
      ...
      $(document).keyup(function (e) {
        if (
          e.keyCode == 27 &&
          $(".navbar-menu .navbar-menu__dropdown a.active").length
        ) {
          close_megamenu();
          $(".overlay").fadeOut();
        }
    ...
    fallbacks: function () {
      ...
      if (isAndroid || isSafari) {
        $(".page-section--global-map, .page-section--network").addClass(
          "page-section--no-fixed-bg"
        );
        $(".resources-list__group, .info-box, .info-box__blue > div").addClass(
          "fallback_no-flexbox"
        );
      }
    },
    ...
    sticky_submenu: function () {
      ...
      function window_scroll() {
        ...
        if (
          $window.scrollTop() >= window_min &&
          $window.scrollTop() < window_max
        ) {
