      ...
      var a = e(window).width(),
        ...
        p = function () {
          ...
          return (
            ...
            (o.settings.slideWidth > t && !o.carousel) ||
            "vertical" == o.settings.mode
              ? (e = t)
            ...
            if (o.settings.infiniteLoop) e = o.children.length / x();
              ...
              for (var t = 0, i = 0; o.children.length > t; )
                ++e,
                  (t = i + v()),
                  (i +=
                    o.settings.moveSlides <= v() ? o.settings.moveSlides : v());
          else e = Math.ceil(o.children.length / v());
          return e;
        },
        x = function () {
          return o.settings.moveSlides > 0 && o.settings.moveSlides <= v()
          ...
          if (
            ...
            o.active.index == f() - 1 && (o.active.last = !0),
              void 0 != t &&
                ("horizontal" == o.settings.mode
                  ? S(-t.left, "reset", 0)
                  : "vertical" == o.settings.mode && S(-t.top, "reset", 0));
          }
        },
        S = function (e, t, i, n) {
          if (o.usingCSS) {
        ...
        T = function () {
          (o.controls.next = e(
            '<a class="bx-next" href="" aria-label="Next">' +
              o.settings.nextText +
              "</a>"
          )),
            (o.controls.prev = e(
              '<a class="bx-prev" href="" aria-label="Previous">' +
                o.settings.prevText +
                "</a>"
            )),
        ...
        I = function () {
          if (o.settings.infiniteLoop) {
            ...
            0 == o.active.index
              ...
              "horizontal" == o.settings.mode
                ? S(-e.left, "reset", 0)
                : "vertical" == o.settings.mode && S(-e.top, "reset", 0);
          }
          (o.working = !1),
